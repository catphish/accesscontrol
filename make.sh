...
CCOPTS="-D NUCLEO -ggdb3 -Wall -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -I$REPOROOT/Drivers/CMSIS/Device/ST/STM32F4xx/Include -I$REPOROOT/Drivers/CMSIS/Include -DSTM32F4xx -O0 -ffast-math"
